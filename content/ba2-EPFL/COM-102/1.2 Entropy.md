...
>$$= - \sum_s p(s) \log p(s) - \log|\mathcal A| =\sum_s p(s) \left\{ -\log p(s) - \log |\mathcal A| \right\}$$  $$=\sum_s p(s) \left( -\log (p(s) |\mathcal A|) \right)=\sum_s p(s) \log \frac1{p(s)|\mathcal A|}$$  $$
>\le\sum_s p(s) \left[ \frac1{p(s)|\mathcal A|} - 1 \right] \log e = \left\{ \sum_s \frac1{|\mathcal A|} - \sum_s p(s) \right\} \log e \le 0$$
